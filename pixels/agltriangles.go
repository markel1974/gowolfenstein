...
var (
	_ ITrianglesPosition = (*GLTriangles)(nil)
	_ ITrianglesColor    = (*GLTriangles)(nil)
	_ ITrianglesPicture  = (*GLTriangles)(nil)
	_ ITrianglesClipped  = (*GLTriangles)(nil)
)
...
func (gt *GLTriangles) updateData(t ITriangles) {
